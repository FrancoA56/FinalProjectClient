  ...
  return (
    ...
    <div className="flex mr-8">
      ...
      {isDarkMode ? (
         ...
         class=" w-auto whitespace-nowrap bg-transparent px-3 py-2 text-sm font-normal text-gray-700 hover:bg-transparent focus:bg-transparent focus:outline-none active:text-zinc-800 active:no-underline disabled:pointer-events-none disabled:bg-transparent disabled:text-gray-400 dark:text-gray-100 dark:hover:bg-transparent focus:dark:bg-gray-600"
         href="#"
         data-theme="light"
       ...
       >
        ...
        class="w-auto whitespace-nowrap bg-transparent px-3 py-2 text-sm font-normal text-gray-700 hover:bg-gray-100 focus:bg-gray-200 focus:outline-none active:text-zinc-800 active:no-underline disabled:pointer-events-none disabled:bg-transparent disabled:text-gray-400 dark:text-gray-100 dark:hover:bg-gray-600 focus:dark:bg-gray-600"
        href="#"
        data-theme="dark"
