  ...
  return (
    <div class="bg-[#d9d9d9] ">
      <div class="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:max-w-7xl lg:px-8">
        <h2 class="text-2xl font-bold tracking-tight  text-white not-italic text-xs font-medium leading-tight row-span-1 border  bg-gradient-to-r from-[#2f4c54] to-[#196e5a] border-none ">
        ...
        <div class="mt-6 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-4 xl:gap-x-8">
          <div class="group relative">
            ...
            <div class="mt-4 flex justify-between">
              <div>
                ...
                <p class="mt-1 text-sm text-gray-500">Natural Wood</p>
              </div>
          ...
          <div class="group relative">
            ...
            <div class="mt-4 flex justify-between">
              <div>
                ...
                <p class="mt-1 text-sm text-gray-500">Toasted</p>
              </div>
          ...
          <div class="group relative">
            ...
            <div class="mt-4 flex justify-between">
              ...
              <p class="text-sm font-medium text-gray-900">$135</p>
            </div>
            <div className="bg-[#a6a6a6] border-[#737373]">
            <button className=" text-white not-italic text-xs font-medium uppercase ">
              Add to cart
          ...
          <div class="group relative">
            ...
            <div class="mt-4 flex justify-between">
              ...
              <p class="text-sm font-medium text-gray-900">$220</p>
            </div>
            <div className="bg-[#a6a6a6] border-[#737373]">
            <button className=" text-white not-italic text-xs font-medium uppercase ">
              Add to cart
          ...
          <div class="group relative">
            ...
            <div class="mt-4 flex justify-between">
              <div>
                ...
                <p class="mt-1 text-sm text-gray-500">Mustard</p>
              </div>
              <p class="text-sm font-medium text-gray-900">$350</p>
            </div>
            <div className="bg-[#a6a6a6] border-[#737373]">
