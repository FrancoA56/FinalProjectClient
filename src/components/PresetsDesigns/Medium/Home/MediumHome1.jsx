...
const MediumHome1 = () => {
  ...
  return (
    ...
    <div className="grid h-screen">
      {/*BANNER */}
      <div className="row-span-1 bg-gradient-to-r from-[#2f4c54] to-[#38533c] text-white block px-3 py-2 text-base font-medium dark:text-neutral-300">
        {" "}
        Minimalist Furniture Shop{" "}
      </div>
      {/* NAV */}
      <nav className="row-span-1 bg-[#a6a6a6] text-white dark:bg-gray-800 ">
        <div class="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
          <div class="relative flex h-14 items-center justify-between">
            ...
            <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
              ...
              <div class="hidden sm:ml-6 sm:block">
                <div class="flex space-x-4">
                  <a
                    href="#"
                    class="bg-[#d5a123] text-white rounded-md px-3 py-2 text-sm font-medium dark:text-black"
                    aria-current="page"
                  >
                    Shop
                  </a>
            ...
            <div class="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
              ...
              <button
                type="button"
                class="relative rounded-full bg-[#d5a123] p-1 text-white hover:text-white focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800 dark:text-black"
              >
      ...
      <div className="row-span-6">
        ...
        <div className="grid grid-cols-5 h-full">
          ...
          <div className="col-span-1 bg-gray-200 flex items-center justify-center dark:bg-gray-600"></div>
          <div className="col-span-3 bg-gray-200 dark:bg-gray-600">
            {" "}
            <div
            ...
            >
              ...
              <div class="relative w-full  after:clear-both after:block after:content-['']">
                ...
                {/* Second item */}
                <div
                  class=" w-full mb-8 transition-transform duration-[600ms] ease-in-out motion-reduce:transition-none"
                  data-te-carousel-item
                  style={{ backfaceVisibility: "hidden" }}
                >
                  <img
          ...
          <div className="col-span-1 bg-gray-200 dark:bg-gray-600 "></div>
        </div>
      </div>
      {/* FOOTER */}{" "}
      <footer class="flex flex-col items-center bg-neutral-200 text-center row-span-1 bg-gradient-to-r from-[#2f4c54] to-[#38533c] text-white">
        ...
        {/*<!--Copyright section-->  */}
        <div class="w-full bg-[#a6a6a6] p-2 text-center text-neutral-700 dark:bg-neutral-700 dark:text-neutral-100">
          © 2023 Copyright:
          <a
