        ...
        <div className="container mx-auto p-4">
          ...
          <div className="grid grid-cols-12 gap-4">
            <div className="col-span-12 md:col-span-4 rounded-md h-screen grid grid-rows-4 bg-gray-300 dark:bg-[#303030] flex justify-center items-center">
              <div
                className="h-1/2 mt-64 mx-6 text-neutral-500 px-4 py-8 transition duration-200 hover:text-neutral-700 hover:ease-in-out 
            ...
            <div className="col-span-12 md:col-span-8 h-screen rounded-md overflow-hidden"
              style={{
                background:
            ...
            <ul
              role="list"
              className="grid gap-x-8 gap-y-12 sm:grid-cols-2 sm:gap-y-16 xl:col-span-2 mt-12 ml-8"
            >
              {people.map((person) => (
                <li key={person.name}>
                  <div className="grid grid-cols-6 gap-4">
                    ...
                    <div className="col-span-2 ml-4" >
                      <h3 className=" rounded 5ec3bf px-8 pb-2.5 pt-3 text-sm font-medium uppercase leading-normal text-white ">
                        {person.name}
                      </h3>
                      <p className="text-sm font leading-6 text-gray-400">
                        {person.role}
                      </p>
                    </div>

                    <div className="col-span-1 flex items-center ml-6 mt-4">
                      {/* LinkedIn section */}
                      <a
                      ...
                      >
                        <svg
                          ...
                          class="h-4 w-4 mr-4 mb-1 text-logo"
                          fill="currentColor"
                          viewBox="0 0 24 24"
                          stroke="currentColor"
                        >
