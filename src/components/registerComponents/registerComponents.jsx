              ...
              <form onSubmit={(e) => handleSubmit(e)}>
                ...
                <div className="mb-4">
                  <input
                    ...
                    required
                  />
                <p className="text-[#5ec3bf] text-xs absolute ">{errors.name}</p>
                </div>
                ...
                <div className="mb-4">
                  <input
                    ...
                    required
                  />
                <p className="text-[#5ec3bf] text-xs absolute">{errors.email} </p>
                </div>
                ...
                <div className="mb-4">
                  <input
                    ...
                    required
                  />
                <p className="text-[#5ec3bf] text-xs absolute">{errors.password}</p>
                </div>
                ...
                <div className="mb-4">
                  <input
                    ...
                    required
                  />
                <p className="text-[#5ec3bf] text-xs absolute">{errors.logo}</p>
                </div>
                ...
                <a
                  ...
                  href="https://accounts.google.com/v3/signin/identifier?hl=es-419&ifkv=AYZoVhcb3SwAgZWQunnl7AVZ1CkvQWZSSeqwZrcgLM1noikjyYZwxMlvMpZStgkY_bZ06qtRwVctig&flowName=GlifWebSignIn&flowEntry=ServiceLogin&dsh=S-1677022196%3A1696175973498605&theme=glif"
                  role="button"
                  data-te-ripple-init
                  data-te-ripple-color="light"
                >
